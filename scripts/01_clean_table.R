...
birds <- read_csv("data/pa_breeding_bird_calendar_2025_02.csv")
...
birds <- birds |>
  mutate(
    priority_species = str_detect(common_name, "\\*"),
...
write_csv(breeding_calendar, "data/breeding_calendar.csv")

write_csv(bird_safe_dates, "data/bird_safe_dates.csv")
